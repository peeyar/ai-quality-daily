"""Planner subgraph for JobScout v5.
...
v5 difference from v4: the node body is wrapped in a `v5.planner` span so
Phoenix shows the planner as a distinct child of the orchestrator span.
"""
import os
...
def build_planner_graph():
    ...
    def planner_node(state: PlannerState):
        with tracer.start_as_current_span("v5.planner"):
            messages = [
