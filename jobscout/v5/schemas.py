"""Pydantic schemas for JobScout v5.

v5 reuses v4's models verbatim. Structurally identical — v5's only difference
from v4 is Phoenix observability woven into the agent code.
"""
from pydantic import BaseModel, Field


# Reused from v2/v3/v4 (recopied here so v5 is standalone)
