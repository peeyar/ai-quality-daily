"""Bridges v5's structured SearchQuery to the v1-era mock_search function.
...
This avoids modifying shared/mock_jobs.py while still giving v5 structured
...
from v5.schemas import SearchQuery, JobSearchResult, SearchResults
