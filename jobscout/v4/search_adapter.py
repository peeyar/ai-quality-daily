"""Bridges v4's structured SearchQuery to the v1-era mock_search function.
...
This avoids modifying shared/mock_jobs.py while still giving v4 structured
...
from v4.schemas import SearchQuery, JobSearchResult, SearchResults
